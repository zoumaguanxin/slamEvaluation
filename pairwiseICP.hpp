...
namespace map3d{
  ...
  class ICP{
    public:
       ...
       */
      ICP(int k_=500,float search_r_up_=1010, float d_threshold_=10,float step_degrade_=25,float floor_r_=5,float search_r_low_=0, float filter_low_bounds_=0, float timeout_=0.5, bool flag_=true)
      {
	k=k_;
	...
	targetCloudPtr=TCP;
       ...
       * 
       */
      void setReJectThrehold(float search_r_up_,float mirror_threshold_, float step_degrade_,float floor_r_)
      {
	search_r_up=search_r_up_;
	d_threshold=mirror_threshold_;
	step_degrade=step_degrade_;
	floor_r=floor_r_;
      }
